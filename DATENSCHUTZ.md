# Datenschutzerklärung für Eversicht (ClaroApp)

**Zuletzt aktualisiert:** 20. Oktober 2025

Wir legen grössten Wert auf den Schutz Ihrer persönlichen Daten. Eversicht wurde nach dem Prinzip **"Privacy by Design"** entwickelt. Das bedeutet, dass Ihre Daten standardmässig so privat und sicher wie möglich bleiben.

## 1. Grundsatz der Datenverarbeitung

Der Entwickler von Eversicht hat **zu keinem Zeitpunkt Zugriff** auf Ihre privaten Inhalte. Ihre Daten werden ausschliesslich dazu verarbeitet, Ihnen die Funktionen der App bereitzustellen.
...
Die App verarbeitet die folgenden von Ihnen eingegebenen Daten ausschliesslich zu den genannten Zwecken:
...
### 2.3 Lokale Dokumentenanalyse (OCR)

Die App nutzt die Apple-Frameworks **Vision** und **NaturalLanguage** zur Texterkennung aus gescannten Dokumenten oder Bildern.

* Die Analyse erfolgt **ausschliesslich auf Ihrem Gerät**.
* Zu keinem Zeitpunkt werden Ihre Dokumente, Fotos oder deren Textinhalte an den App-Entwickler oder externe Server gesendet.

## 3. Berechtigungen und Externe Services
...
Julien Pavel Buncak
Lindenstrasse 33, 4123 Allwil
E-Mail: infojulienb@gmail.com
